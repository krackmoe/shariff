...
(function (global){
"use strict";var $=(typeof window !== "undefined" ? window['jQuery'] : typeof global !== "undefined" ? global['jQuery'] : null),url=require("url"),Shariff=function(t,e){var i=this;this.element=t,$(t).empty(),this.options=$.extend({},this.defaults,e,$(t).data());var r=[require("./services/addthis"),require("./services/facebook"),require("./services/facebook-like"),require("./services/googleplus"),require("./services/info"),require("./services/linkedin"),require("./services/mail"),require("./services/pinterest"),require("./services/twitter"),require("./services/whatsapp"),require("./services/xing"),require("./services/tumblr")];this.services=$.map(this.options.services,function(t){var e;return r.forEach(function(r){if(r=r(i),r.name===t)return console.log("availableServiceName: "+r.name),e=r,null}),e}),this._addButtonList(),null!==this.options.backendUrl&&this.getShares().then($.proxy(this._updateCounts,this))};Shariff.prototype={defaults:{theme:"color",backendUrl:null,infoUrl:"http://ct.de/-2467514",lang:"de",langFallback:"en",mailUrl:function(){var t=url.parse(this.getURL(),!0);return t.query.view="mail",delete t.search,url.format(t)},mailSubject:function(){return this.getMeta("DC.title")||this.getTitle()},mailBody:function(){return"<"+this.getURL()+">"},mediaUrl:null,orientation:"horizontal",referrerTrack:null,countDivisor:1e3,countDivisionStart:1e3,countRoundPrecision:0,services:["twitter","facebook","facebook-like","googleplus","info"],title:function(){return $("head title").text()},twitterVia:null,url:function(){var t=global.document.location.href,e=$("link[rel=canonical]").attr("href")||this.getMeta("og:url")||"";return e.length>0&&(e.indexOf("http")<0&&(e=global.document.location.protocol+"//"+global.document.location.host+e),t=e),t}},$socialshareElement:function(){return $(this.element)},getLocalized:function(t,e){return"object"==typeof t[e]?void 0===t[e][this.options.lang]?t[e][this.options.langFallback]:t[e][this.options.lang]:"string"==typeof t[e]?t[e]:void 0},getMeta:function(t){return $('meta[name="'+t+'"],[property="'+t+'"]').attr("content")||""},getInfoUrl:function(){return this.options.infoUrl},getURL:function(){return this.getOption("url")},getOption:function(t){var e=this.options[t];return"function"==typeof e?$.proxy(e,this)():e},getTitle:function(){return this.getOption("title")},getReferrerTrack:function(){return this.options.referrerTrack||""},getShares:function(){var t=url.parse(this.options.backendUrl,!0);return t.query.url=this.getURL(),delete t.search,$.getJSON(url.format(t))},getCountDivisor:function(){return this.options.countDivisor},getCountDivisionStart:function(){return this.options.countDivisionStart},getCountRoundPrecision:function(){return this.options.countRoundPrecision},_updateCounts:function(t){var e=this,i="";$.each(t,function(t,r){r>=e.getCountDivisionStart()&&(r=Math.round(r/e.getCountDivisor()),i="k"),r>=1e3&&(r=Math.floor(r/1e3)+"."+r%1e3),$(e.element).find("."+t+" a").append('<span class="share_count">'+r+i)})},_addButtonList:function(){var t=this,e=this.$socialshareElement(),i="theme-"+this.options.theme,r="orientation-"+this.options.orientation,n="col-"+this.options.services.length,a=$("<ul>").addClass(i).addClass(r).addClass(n);console.log("services: "+this.services),this.services.forEach(function(e){var i=$('<li class="shariff-button">').addClass(e.name),r='<span class="share_text">'+t.getLocalized(e,"shareText"),n=$("<a>").attr("href",e.shareUrl).append(r);void 0!==e.faName&&n.prepend('<span class="fa '+e.faName+'">'),e.popup?n.attr("rel","popup"):e.blank?n.attr("target","_blank"):e.iframe&&n.attr("rel","iframe"),e.customContent&&(n.attr("data-useCustomContent",e.useCustomContent),n.attr("data-customContent",e.customContent),n.attr("data-name",e.name)),n.attr("title",t.getLocalized(e,"title")),n.attr("role","button"),n.attr("aria-label",t.getLocalized(e,"title")),i.append(n),a.append(i)}),a.on("click",'[rel="popup"]',function(t){t.preventDefault();var e=$(this).attr("href");global.window.open(e,"_blank","width=600,height=460")}),a.on("click",'[rel="iframe"]',function(t){t.preventDefault();var e=$(this).attr("href");$(this).data("width")&&$(this).parent().width($(this).data("width")),$(this).replaceWith('<iframe src="'+e+'"></iframe>')}),a.on("click",'[rel="tooltip"]',function(t){t.preventDefault();var e=$(this).attr("href"),i=$(this).offset().top-150,r=$(this).offset().left;$(this).data("width")&&$(this).parent().width($(this).data("width")),$("body").prepend('<div class="shariff-tooltip" style="top: '+i+"px; left: "+r+'px;">'+$(this).parent().data("popupinfotext")+'<br><br><iframe style="height: 30px;" src="'+e+'"></iframe></div></div>'),$(document).on("click",function(t){void 0===$(t.target).closest(".shariff-tooltip").get(0)&&void 0===$(t.target).closest("div.shariff").get(0)&&($(".shariff-tooltip").remove(),$(this).off(t))})}),a.on("click",'[rel="iframe"]',function(t){t.preventDefault();var e=$(this).attr("href");if($(this).data("width")&&$(this).parent().width($(this).data("width")),$(this).data("useCustomContent")){var i=$(this).data("customContent"),r=$(this).data("name");$(this).replaceWith("<div></div>");var n=$(this);$("<iframe name='"+r+"'></iframe>").load(function(){$("iframe [name='"+r+"]").contents().find("body").html(i)}).appendTo(n)}else $(this).replaceWith('<iframe src="'+e+'"></iframe>')}),e.append(a)}},module.exports=Shariff,global.Shariff=Shariff,$(".shariff").each(function(){this.hasOwnProperty("shariff")||(this.shariff=new Shariff(this))});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./services/addthis":6,"./services/facebook":8,"./services/facebook-like":7,"./services/googleplus":9,"./services/info":10,"./services/linkedin":11,"./services/mail":12,"./services/pinterest":13,"./services/tumblr":14,"./services/twitter":15,"./services/whatsapp":16,"./services/xing":17,"url":5}]},{},[18]);
